...
setup(
    name='tapioca-the-moviedb',
    version=get_version(package),
    description='The MovieDB API wrapper using tapioca',
    ...
    package_dir={'tapioca_the_moviedb': 'tapioca_the_moviedb'},
    include_package_data=True,
    install_requires=requirements,
    license="MIT",
    zip_safe=False,
    keywords='the-moviedb',
    classifiers=[
